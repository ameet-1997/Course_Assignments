...
# Get validation data
train_data, validation_data, train_labels, validation_labels = train_test_split(train_data, train_labels, test_size=2000, stratify=np.array(train_labels)) 
...
bag = SVC(kernel='rbf', C=7, decision_function_shape='ovo')
...
# test_labels.to_csv("sub.csv", index_label=['id','label'])